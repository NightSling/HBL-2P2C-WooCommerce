...
abstract class ActionRequest {
	...
	private function getPaymentEndpoint(): string {
		return self::is_test() ? "https://core.demo-paco.2c2p.com/" : "https://core.paco.2c2p.com/";
	}
	 ...
	 * @return JWK
	 */
	public function GetPrivateKey( string $key, ?string $password = null, array $additional_values = [] ): JWK {
	 ...
	 * @return JWK
	 */
	public function GetPublicKey( string $key, ?string $password = null, array $additional_values = [] ): JWK {
	 ...
	 * @throws Exception
	 */
	public function DecryptToken( string $token, JWK $decryptingKey, JWK $signatureVerificationKey ): string {
